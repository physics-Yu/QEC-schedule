...
from neutral_atom_strategies.motion.qec_readout import choose_readout_service, reject_internal
...
from neutral_atom_strategies.scheduling.qec import qec_cz_groups, readout_groups
...
def _resume_context(state, terminal, compiler):
    ...
    from neutral_atom_strategies.motion.qec_persistent import RetainedCohort
...
def run_qec_joint(state,*,on_event=None,terminal=None,max_decisions=10000,
    ...
    compiler=compiler_type(route_expansions);executor=env
