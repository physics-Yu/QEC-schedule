...
from .patch_greedy import patch_assignment, candidate_groups, preflight_group, batch_service
...
def run_qec(state, *, on_event=None, terminal=None, max_decisions=10000,
    ...
    compiler=PatchArrayCompiler(route_expansions);executor=Executor(state)
