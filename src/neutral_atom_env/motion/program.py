...
from .validation import require, plan_resources
...
def replay_program(plan, state):
    ...
    if task:
        from .task_validation import validate_target
...
class ProgramBuilder:
    ...
    def finish(self, strategy_id):
        from .compiler import fingerprint, exact_validate
        state = self.origin
        from neutral_atom_env.hardware.dynamic_traps import trap_state
        from .task_validation import requested_atoms, task_intervals
