...
def check_final(state,circuit,terminal):
    from neutral_atom_experiments.surface_qec_temporal import summarize, validate_history
...
def compile_case(output):
    from neutral_atom_experiments.surface_qec_temporal import experiment_input, summarize
    ...
    from neutral_atom_experiments.runners.qec_temporal import run_qec_temporal
...
def verify_case(output):
    ...
    from neutral_atom_experiments.surface_qec_temporal import HISTORY_IDS, validate_history
